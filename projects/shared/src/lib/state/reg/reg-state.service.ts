...
import {Auth0ConfigService} from '../../auth/auth0Config/Auth0ConfigService';
import {BASE_URL, HttpService} from '../../api/http/http.service';
...
import {REGISTRATION_TYPE} from '../../auth/auth0Config/registration-type';
